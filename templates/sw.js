...
const CACHE_NAME = 'mastans-catering-v19';
const STATIC_ASSETS = [
    '/staff/login/',
    '/static/icons/icon-192x192.png',
    '/static/icons/icon-512x512.png',
    '/static/icons/icon-192x192_staff.png',
    '/static/icons/icon-512x512_staff.png',
    '/static/images/logo.png',
    '/offline/',
    'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css',
    'https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500;700&family=DM+Sans:wght@300;400;500;700&family=Outfit:wght@400;500;600&display=swap'
];
